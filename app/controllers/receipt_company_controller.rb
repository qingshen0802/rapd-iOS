class ReceiptCompanyController < JsonController
  ...
  def viewDidLoad
    ...
    self.outlets["wallet_label"].text = "VIA #{rapd_transaction.wallet.wallet_type.name.upcase}"
  ...
  def table_data
    [
      {rows: [
        {cell_type: "receipt_header", name: profile.full_name, username: "@#{profile.username}", avatar: profile.photo_url, cpf: "CPNJ: #{}"},
        ...
        {cell_type: "receipt_data", title: "Localização:", value: profile.address},
