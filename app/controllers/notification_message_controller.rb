class NotificationMessageController < JsonController
    attr_accessor :notification, :to_user_id, :notifiable_id

    def viewDidLoad
        self.navigationController.navigationBar.hidden = true
        self.title = "MessageNotification"
        super
        
        self.load_back_button
        self.load_title

        self.outlets["title_label"].text = "@#{notification.to_user_name} #{notification.description.camelize(:lower)}"
